  ...
  return (
    <section className="relative py-24 overflow-hidden border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        {/* Leadership Section */}
        <div className="border border-white/10 rounded-2xl bg-space-900/30 p-8 backdrop-blur-md mb-12">
          <h3 className="text-xl font-bold text-center text-white mb-8 uppercase tracking-widest">Leadership Team</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8">
            {leadership.map((member, index) => (
              <div key={index} className="flex flex-col items-center gap-4 group p-6 rounded-2xl border border-white/5 bg-white/5 hover:border-tech-cyan/30 transition-all">
                <div className="p-4 rounded-full border border-white/10 bg-white/5 group-hover:bg-tech-cyan/10 group-hover:border-tech-cyan/50 transition-all shadow-[0_0_15px_rgba(255,255,255,0.05)]">
                  {member.icon}
                </div>
                <div className="text-center">
                  <h4 className="text-base font-bold text-white transition-colors group-hover:text-tech-cyan">
                    {member.name}
                  </h4>
                  <p className="text-[10px] uppercase tracking-widest text-slate-500 group-hover:text-tech-cyan/70 transition-colors">
                    {member.position}
                  </p>
                </div>
              </div>
